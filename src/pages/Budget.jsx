...
function Budget() {
  ...
  return (
    <div className="page budget-page">
      <div className="budget-page-header">
        <div>
          ...
          <p className="page-description">
            Track wedding costs, payments, balances, vendors, and any
            items that are still estimated.
          </p>
        </div>
      ...
      {error &&
        !showItemModal && (
          <div className="auth-error budget-page-error">
            {error}
        ...
        <>
          ...
          {items.length === 0 ? (
            <section className="content-card budget-empty">
              ...
              <p>
                Add your wedding expenses to track costs,
                payments, balances, and due dates.
              </p>
            ...
            >
              ...
              {vendors.length ===
                ...
                <p className="budget-vendor-help">
                  Add vendors on the Vendors page and they will appear
                  here automatically.
                </p>
              )}
