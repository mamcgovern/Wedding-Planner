...
function Vendors() {
  ...
  const handleDeleteVendor =
    async (
      ...
      const warning =
        linkedItems.length >
        0
          ? ` "${vendor.name}" currently has ${linkedItems.length} linked budget ${
              linkedItems.length ===
              1
                ? "item"
                : "items"
            }. The budget items will not be deleted, but they will no longer have an active vendor record.`
          : "";

      const confirmed =
        window.confirm(
          `Delete "${vendor.name}"?${warning}`
        );
  ...
  return (
    <main className="page vendors-page">
      <div className="vendors-page-header">
        <div>
          ...
          <p className="page-description">
            Keep contacts, contracts, and vendor
            details together while financial
            information stays synced with your budget.
          </p>
        </div>

        <button
          type="button"
          className="primary-button vendors-add-button"
          onClick={
            openAddVendor
          }
        >
      ...
      {loading ? (
        ...
        <section className="content-card vendor-empty">
          ...
          <p>
            Add your booked vendors and any businesses
            ...
            >
              ...
              <div className="vendor-budget-form-note">
                ...
                <div>
                  ...
                  <span>
                    Link expenses to this vendor from the
                    Budget page. Payment instructions and
                    balances will appear here automatically.
                  </span>
                </div>
              </div>
              ...
              {error && (
                <div className="vendor-modal-error">
                  {error}
                </div>
              )}
      ...
      0 ? (
          ...
          {financials.nextDueItem && (
            <div className="vendor-due-date">
              ...
              <span>
                ...
                <strong>
                  {formatDate(
                    financials.nextDueItem.dueDate
                  )}
                </strong>
              </span>
            </div>
        ...
        <div className="vendor-no-budget">
          ...
          <div>
            ...
            <span>
              Link a budget item to this vendor from
              the Budget page.
            </span>
          </div>
        </div>
