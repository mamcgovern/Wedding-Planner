...
function SeatingChart() {
   ...
   * is included unless they declined.
   */
   ...
   * CLEAR TABLE
   *
   * Keeps the table but returns
   * everyone to Unseated.
   */
   ...
   * DELETE TABLE
   *
   * Guests are returned to Unseated
  ...
  return (
    <div className="page seating-page">
      <div className="seating-page-header">
        <div>
          ...
          <p className="page-description">
            Arrange confirmed and pending guests while RSVP responses
            are still coming in.
          </p>
        </div>
      ...
      {error && (
        <div className="auth-error seating-error">
          {error}
        ...
        <div className="seating-layout">
          ...
          >
            ...
            <div className="unseated-drop-hint">
              Drag guests or an entire family onto a table. Drop them
              back here to remove their seating assignment.
            </div>
            ...
            0 ? (
              <div className="unseated-empty">
                ...
                <span>
                  Every guest who has not declined currently has a
                  table assignment.
                </span>
              </div>
            ) : (
          ...
          <main className="table-area">
            ...
            0 ? (
              <div className="content-card seating-no-tables">
                ...
                <p>
                  Add your reception tables, then drag guests into
                  them.
                </p>
